...
public class AppRater {
	...
	private final static String APP_TITLE = "Prayer Times";
	private final static String APP_PACKAGE_NAME = "com.karimo.prayertimes";
	
//	Initialized to 0 and 3 only for test purposes. In real app change this
	private final static int DAYS_UNTIL_PROMPT = 0;
	private final static int LAUNCH_UNTIL_PROMPT = 30;
